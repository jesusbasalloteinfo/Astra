...
<script lang="ts">
    ...
    import { LayoutDashboard, History, Telescope, MapPin, User, Plus } from 'lucide-svelte';
    ...
    const navItems = [
        ...
        { href: '/dashboard/telescope', icon: Telescope,       label: m.dash_side_telescope() },
...
<aside class="w-60 flex-shrink-0 flex flex-col border-r border-border bg-secondary h-screen sticky top-0">
    ...
    <!-- New session CTA -->
    <div class="px-4 pt-4">
        <button class="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg
    ...
    <!-- Bottom -->
    <div class="px-4 py-4 border-t border-border flex flex-col gap-2">
        <button
